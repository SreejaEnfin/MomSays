...
export const QuestionCarousel = ({ questions, selectedQuestionIds, toggleQuestionSelection, step }: Props) => {
    const [currentIndex, setCurrentIndex] = useState(0);

    if (!questions || questions.length === 0 && step === 'question-selection') {
    ...
    const isSelected = selectedQuestionIds.includes(currentQuestion.id);
